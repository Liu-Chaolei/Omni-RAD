...
def main(method, base_config, test_config, stage):
    ...
    for img_path in images:
        ...
        with torch.no_grad():
            try:
                pos_tag_prompt = [1]
                x_hat, RateLossOutput = net(img_padded, pos_tag_prompt, ori_h, ori_w)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Fixed-rate 4/256-channel baseline evaluation.")
    parser.add_argument("--method", type=str, choices=["channel"], default="channel")
