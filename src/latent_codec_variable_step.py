...
class LatentCodec(CompressionModel):
    ...
    Compared to the variable-rate version (latent_codec_variable.py):
      ...
      • rate (TargetRateModule)       — unchanged: lmbda passed at forward time
      • dynamic_timestep              — NEW: DynamicTimestepModule, σ → T*

    Interface change vs. latent_codec_variable:
