"""
testv1_variable3_debug_step.py — Testing script for variable-rate StableCodec
with SNR-based dynamic timestep T*.

Evaluates the model at multiple λ values to produce a full RD curve.
Uses StableCodec_variable2_step (D/λ + bpp loss, dynamic T*).
Reports per-image and per-λ T* statistics alongside BPP/PSNR/LPIPS.
"""
