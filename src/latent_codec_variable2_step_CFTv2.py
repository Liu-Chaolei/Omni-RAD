"""
latent_codec_variable2_step_CFTv2.py  —  CFT v2 variant of latent codec.

CFTv2 changes vs. A0 (latent_codec_variable2_step.py):
...
ScaleFeatureAdapter + CFTFusionModule + WPolicyNet in
StableCodec_variable2_step_CFTv2.py.
...
class LatentCodec(CompressionModel):
    ...
    def decompress(self, strings, shape, lmbda=None):
        ...
        # CFTv2: scales_all must be returned for the model-level modules.
        scales_all = ss0 * m0 + ss1 * m1 + ss2 * m2 + ss3 * m3
