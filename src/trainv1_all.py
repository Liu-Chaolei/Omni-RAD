...
def save_model(
    ...
    ckpt_dict = {
            ...
            "state_dict_fusion": unwarp_net.fusion.state_dict(),
...
# CUDA_VISIBLE_DEVICES=5 accelerate launch --num_processes 1 src/trainv1_all.py --stage 2 --MASTER_PORT 12356 --experiment_name ft2_step999_new
