...
# CUDA_VISIBLE_DEVICES=1 accelerate launch --num_processes 1 src/trainv1_b_all.py --stage 1 --MASTER_PORT 12355 --elic_path /data/ssd/liuchaolei/models/StableCodec/checkpoints/elic_official.pth --lambda_rate 2 --experiment_name base
